...
import { FaAward, FaUsers, FaRocket, FaHandshake, FaCode, FaLightbulb, FaFlag, FaEnvelope, FaPhone, FaMapMarkerAlt } from 'react-icons/fa';
...
export default function AboutPage() {
  ...
  return (
    <>
      <Head>
        <title>About Us - CityLyfe LLC | Veteran-Owned Software Engineering</title>
        <meta name="description" content="Learn about CityLyfe LLC - a veteran-owned cybersecurity and software engineering firm specializing in secure distributed systems, AI-powered solutions, and enterprise-grade applications." />
      </Head>
      ...
      <main className="pt-20">
            ...
            <div className="text-center mb-12">
              ...
              <div className="flex justify-center">
                <div className="bg-red-50 border-2 border-red-200 rounded-lg px-6 py-3 flex items-center space-x-3">
                  ...
                  <span className="text-red-800 font-semibold">Veteran Owned</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-12 px-4 bg-white">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                {values.map((value, index) => (
                  <div key={index} className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 text-center border border-gray-100">
            ...
            {/* Founder Section */}
            <div className="bg-gray-50 rounded-2xl p-12 shadow-lg border border-gray-100">
              <div className="text-center mb-12">
              ...
              <div className="max-w-2xl mx-auto">
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Matthew Kenner</h3>
                  ...
                  {/* Skills */}
                  <div className="mt-8">
                    <h4 className="font-semibold text-gray-900 mb-4">Technical Expertise:</h4>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Ready to transform your business with custom IT solutions? We're here to help bring your vision to life.
              </p>
            </div>
